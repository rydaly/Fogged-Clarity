...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> itemscope itemprop="ImageGallery" itemtype="https://schema.org/ImageGallery">
	<?php tha_entry_top(); ?>
	...
	<footer class="entry-meta">
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'foggedclarity' ), __( '1 Comment', 'foggedclarity' ), __( '% Comments', 'foggedclarity' ) ); ?></span>
		<?php endif; ?>
